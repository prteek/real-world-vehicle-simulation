...
def simulation(battery_capacity_kwh, plug_full_charge_time_hrs):
    ...
    battery.capacity = battery_capacity_kwh * 1000 * 3600  # [J] 70 kWh
    battery.plug_full_charge_time = plug_full_charge_time_hrs * 3600  # [sec] 8 hrs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--battery-capacity-kwh", type=float, default=70)
    parser.add_argument("--plug-full-charge-time-hrs", type=float, default=8)

    args = parser.parse_args()
    battery_capacity_kwh = args.battery_capacity_kwh
    plug_full_charge_time_hrs = args.plug_full_charge_time_hrs

    simulation(battery_capacity_kwh, plug_full_charge_time_hrs)
