...
class constant_parameter_electric_machine:
    ...
    generating_mechanical_power_limit = (
        -np.Inf
    )  # [W] : Could be changed to torque limit
    ...
    def calculate_battery_current_demand(self, power_demand, battery):
        ...
        self.battery_current_demand = (
            -self.electrical_power / self.voltage
        )  # Make sure to flip the sign to follow sign conventions
